...
function Home() {
  return (
    <>
    <h1 class="mainHeading"> Coffee my first love</h1>
    <aside>
        <blockquote>
            <img src="images/4.jpg" alt={"images/4.jpg"} width="100px" height="100px"/>
        </blockquote>
    ...
    <section>
        <div class="container">Coffee is actually very healthy.
